const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Hey there! Welcome to Sedata, Sedata is a powerful AI chatbot that truly understands you because it learns from your data.",
    user1:
      "Exciting! How do I get started?!",
    part2:
      "Getting Started is very easy! 🚀 Everything in Sedata is organized into what we call “Workspaces”. Think of these as smart folders where you can store files, documents, images, PDFs, and other content. Our AI will transform these into interactive knowledge that you can chat with! Feel free to add or remove files anytime. Create your first workspace now!",
    user2: "Interesting, Is this like a smart digital assistant? What about the chat features?",
    part3: "Sedata is more than an assistant.\n\Sedata offers two ways of talking with your data:\n\n<i>Query:</i> Your chats will return data or inferences found with the documents in your workspace it has access to. Adding more documents to the Workspace make it smarter! \n\n<i>Conversational:</i> Your documents + your on-going chat history both contribute to the LLM knowledge at the same time. Great for appending real-time text-based info or corrections and misunderstandings the LLM might have. \n\nYou can toggle between either mode \n<i>in the middle of chatting!</i>",
    user3: "Wow, this sounds amazing, let me try it out already!",
    part4: "Have Fun!",
    createWorkspace: "Create your first workspace hello",
  },
